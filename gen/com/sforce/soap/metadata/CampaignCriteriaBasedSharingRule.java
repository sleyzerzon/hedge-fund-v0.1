 ...
 */
public class CampaignCriteriaBasedSharingRule extends com.sforce.soap.metadata.CriteriaBasedSharingRule {
    ...
    /**
     * element : campaignAccessLevel of type {http://soap.sforce.com/2006/04/metadata}ShareAccessLevelNoNone
    ...
    private static final com.sforce.ws.bind.TypeInfo campaignAccessLevel__typeInfo =
      new com.sforce.ws.bind.TypeInfo("http://soap.sforce.com/2006/04/metadata","campaignAccessLevel","http://soap.sforce.com/2006/04/metadata","ShareAccessLevelNoNone",1,1,true);

    private boolean campaignAccessLevel__is_set = false;

    private com.sforce.soap.metadata.ShareAccessLevelNoNone campaignAccessLevel;

    public com.sforce.soap.metadata.ShareAccessLevelNoNone getCampaignAccessLevel() {
      return campaignAccessLevel;
    }

    public void setCampaignAccessLevel(com.sforce.soap.metadata.ShareAccessLevelNoNone campaignAccessLevel) {
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "http://soap.sforce.com/2006/04/metadata", "CampaignCriteriaBasedSharingRule");
    ...
    protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
       ...
       __typeMapper.writeObject(__out, campaignAccessLevel__typeInfo, campaignAccessLevel, campaignAccessLevel__is_set);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        __in.peekTag();
        if (__typeMapper.verifyElement(__in, campaignAccessLevel__typeInfo)) {
            setCampaignAccessLevel((com.sforce.soap.metadata.ShareAccessLevelNoNone)__typeMapper.readObject(__in, campaignAccessLevel__typeInfo, com.sforce.soap.metadata.ShareAccessLevelNoNone.class));
        }
        __in.peekTag();
    ...
    public String toString() {
      ...
      sb.append("[CampaignCriteriaBasedSharingRule ");
      sb.append(super.toString());sb.append(" booleanFilter='").append(com.sforce.ws.util.Verbose.toString(booleanFilter)).append("'\n");
      sb.append(" campaignAccessLevel='").append(com.sforce.ws.util.Verbose.toString(campaignAccessLevel)).append("'\n");
