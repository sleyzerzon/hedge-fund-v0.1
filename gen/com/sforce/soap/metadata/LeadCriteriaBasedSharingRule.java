 ...
 */
public class LeadCriteriaBasedSharingRule extends com.sforce.soap.metadata.CriteriaBasedSharingRule {
    ...
    /**
     * element : leadAccessLevel of type {http://soap.sforce.com/2006/04/metadata}ShareAccessLevelReadEdit
    ...
    private static final com.sforce.ws.bind.TypeInfo leadAccessLevel__typeInfo =
      new com.sforce.ws.bind.TypeInfo("http://soap.sforce.com/2006/04/metadata","leadAccessLevel","http://soap.sforce.com/2006/04/metadata","ShareAccessLevelReadEdit",1,1,true);

    private boolean leadAccessLevel__is_set = false;

    private com.sforce.soap.metadata.ShareAccessLevelReadEdit leadAccessLevel;

    public com.sforce.soap.metadata.ShareAccessLevelReadEdit getLeadAccessLevel() {
      return leadAccessLevel;
    }

    public void setLeadAccessLevel(com.sforce.soap.metadata.ShareAccessLevelReadEdit leadAccessLevel) {
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "http://soap.sforce.com/2006/04/metadata", "LeadCriteriaBasedSharingRule");
    ...
    protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
       ...
       __typeMapper.writeObject(__out, leadAccessLevel__typeInfo, leadAccessLevel, leadAccessLevel__is_set);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        __in.peekTag();
        if (__typeMapper.verifyElement(__in, leadAccessLevel__typeInfo)) {
            setLeadAccessLevel((com.sforce.soap.metadata.ShareAccessLevelReadEdit)__typeMapper.readObject(__in, leadAccessLevel__typeInfo, com.sforce.soap.metadata.ShareAccessLevelReadEdit.class));
        }
        __in.peekTag();
    ...
    public String toString() {
      ...
      sb.append("[LeadCriteriaBasedSharingRule ");
      ...
      sb.append(" leadAccessLevel='").append(com.sforce.ws.util.Verbose.toString(leadAccessLevel)).append("'\n");
