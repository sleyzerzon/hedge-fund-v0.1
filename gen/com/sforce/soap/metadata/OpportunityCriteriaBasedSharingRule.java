 ...
 */
public class OpportunityCriteriaBasedSharingRule extends com.sforce.soap.metadata.CriteriaBasedSharingRule {
    ...
    /**
     * element : opportunityAccessLevel of type {http://soap.sforce.com/2006/04/metadata}ShareAccessLevelReadEdit
    ...
    private static final com.sforce.ws.bind.TypeInfo opportunityAccessLevel__typeInfo =
      new com.sforce.ws.bind.TypeInfo("http://soap.sforce.com/2006/04/metadata","opportunityAccessLevel","http://soap.sforce.com/2006/04/metadata","ShareAccessLevelReadEdit",1,1,true);

    private boolean opportunityAccessLevel__is_set = false;

    private com.sforce.soap.metadata.ShareAccessLevelReadEdit opportunityAccessLevel;

    public com.sforce.soap.metadata.ShareAccessLevelReadEdit getOpportunityAccessLevel() {
      return opportunityAccessLevel;
    }

    public void setOpportunityAccessLevel(com.sforce.soap.metadata.ShareAccessLevelReadEdit opportunityAccessLevel) {
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "http://soap.sforce.com/2006/04/metadata", "OpportunityCriteriaBasedSharingRule");
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.verifyElement(__in, opportunityAccessLevel__typeInfo)) {
            setOpportunityAccessLevel((com.sforce.soap.metadata.ShareAccessLevelReadEdit)__typeMapper.readObject(__in, opportunityAccessLevel__typeInfo, com.sforce.soap.metadata.ShareAccessLevelReadEdit.class));
        }
    }
    ...
    public String toString() {
      ...
      sb.append("[OpportunityCriteriaBasedSharingRule ");
