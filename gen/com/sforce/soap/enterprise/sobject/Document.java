...
public class Document extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append("[Document ");
      sb.append(super.toString());sb.append(" Author='").append(com.sforce.ws.util.Verbose.toString(Author)).append("'\n");
      sb.append(" AuthorId='").append(com.sforce.ws.util.Verbose.toString(AuthorId)).append("'\n");
      ...
      sb.append(" IsBodySearchable='").append(com.sforce.ws.util.Verbose.toString(IsBodySearchable)).append("'\n");
      sb.append(" IsDeleted='").append(com.sforce.ws.util.Verbose.toString(IsDeleted)).append("'\n");
      sb.append(" IsInternalUseOnly='").append(com.sforce.ws.util.Verbose.toString(IsInternalUseOnly)).append("'\n");
      sb.append(" IsPublic='").append(com.sforce.ws.util.Verbose.toString(IsPublic)).append("'\n");
