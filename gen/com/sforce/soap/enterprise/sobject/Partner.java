...
public class Partner extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append("[Partner ");
      sb.append(super.toString());sb.append(" AccountFrom='").append(com.sforce.ws.util.Verbose.toString(AccountFrom)).append("'\n");
      sb.append(" AccountFromId='").append(com.sforce.ws.util.Verbose.toString(AccountFromId)).append("'\n");
      sb.append(" AccountTo='").append(com.sforce.ws.util.Verbose.toString(AccountTo)).append("'\n");
      sb.append(" AccountToId='").append(com.sforce.ws.util.Verbose.toString(AccountToId)).append("'\n");
      ...
      sb.append(" IsPrimary='").append(com.sforce.ws.util.Verbose.toString(IsPrimary)).append("'\n");
      ...
      sb.append(" ReversePartnerId='").append(com.sforce.ws.util.Verbose.toString(ReversePartnerId)).append("'\n");
