...
public class Group extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append(" DoesIncludeBosses='").append(com.sforce.ws.util.Verbose.toString(DoesIncludeBosses)).append("'\n");
      sb.append(" DoesSendEmailToMembers='").append(com.sforce.ws.util.Verbose.toString(DoesSendEmailToMembers)).append("'\n");
      ...
      sb.append(" QueueSobjects='").append(com.sforce.ws.util.Verbose.toString(QueueSobjects)).append("'\n");
      sb.append(" RelatedId='").append(com.sforce.ws.util.Verbose.toString(RelatedId)).append("'\n");
