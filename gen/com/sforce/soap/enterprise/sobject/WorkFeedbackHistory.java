 ...
 */
public class WorkFeedbackHistory extends com.sforce.soap.enterprise.sobject.SObject {

    /**
     * Constructor
     */
    public WorkFeedbackHistory() {}
    ...
    /**
     * element : WorkFeedback of type {urn:sobject.enterprise.soap.sforce.com}WorkFeedback
     * java type: com.sforce.soap.enterprise.sobject.WorkFeedback
     */
    private static final com.sforce.ws.bind.TypeInfo WorkFeedback__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","WorkFeedback","urn:sobject.enterprise.soap.sforce.com","WorkFeedback",0,1,true);

    private boolean WorkFeedback__is_set = false;

    private com.sforce.soap.enterprise.sobject.WorkFeedback WorkFeedback;

    public com.sforce.soap.enterprise.sobject.WorkFeedback getWorkFeedback() {
      return WorkFeedback;
    }

    public void setWorkFeedback(com.sforce.soap.enterprise.sobject.WorkFeedback WorkFeedback) {
      this.WorkFeedback = WorkFeedback;
      WorkFeedback__is_set = true;
    }

    /**
     * element : WorkFeedbackId of type {urn:enterprise.soap.sforce.com}ID
     * java type: java.lang.String
     */
    private static final com.sforce.ws.bind.TypeInfo WorkFeedbackId__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","WorkFeedbackId","urn:enterprise.soap.sforce.com","ID",0,1,true);

    private boolean WorkFeedbackId__is_set = false;

    private java.lang.String WorkFeedbackId;

    public java.lang.String getWorkFeedbackId() {
      return WorkFeedbackId;
    }

    public void setWorkFeedbackId(java.lang.String WorkFeedbackId) {
      this.WorkFeedbackId = WorkFeedbackId;
      WorkFeedbackId__is_set = true;
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "WorkFeedbackHistory");
    ...
    protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
       ...
       __typeMapper.writeObject(__out, WorkFeedback__typeInfo, WorkFeedback, WorkFeedback__is_set);
       __typeMapper.writeString(__out, WorkFeedbackId__typeInfo, WorkFeedbackId, WorkFeedbackId__is_set);
    }
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, WorkFeedback__typeInfo)) {
            setWorkFeedback((com.sforce.soap.enterprise.sobject.WorkFeedback)__typeMapper.readObject(__in, WorkFeedback__typeInfo, com.sforce.soap.enterprise.sobject.WorkFeedback.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, WorkFeedbackId__typeInfo)) {
            setWorkFeedbackId(__typeMapper.readString(__in, WorkFeedbackId__typeInfo, java.lang.String.class));
        }
    }
    ...
    public String toString() {
      ...
      sb.append(" WorkFeedback='").append(com.sforce.ws.util.Verbose.toString(WorkFeedback)).append("'\n");
      sb.append(" WorkFeedbackId='").append(com.sforce.ws.util.Verbose.toString(WorkFeedbackId)).append("'\n");
      sb.append("]\n");
      return sb.toString();
    }
