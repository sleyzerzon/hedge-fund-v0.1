 ...
 */
public class WorkFeedback extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    /**
     * element : Feedback of type {http://www.w3.org/2001/XMLSchema}string
     * java type: java.lang.String
     */
    private static final com.sforce.ws.bind.TypeInfo Feedback__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Feedback","http://www.w3.org/2001/XMLSchema","string",0,1,true);

    private boolean Feedback__is_set = false;
    ...
    /**
     * element : Question of type {urn:sobject.enterprise.soap.sforce.com}WorkFeedbackQuestion
     * java type: com.sforce.soap.enterprise.sobject.WorkFeedbackQuestion
     */
    private static final com.sforce.ws.bind.TypeInfo Question__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Question","urn:sobject.enterprise.soap.sforce.com","WorkFeedbackQuestion",0,1,true);

    private boolean Question__is_set = false;

    private com.sforce.soap.enterprise.sobject.WorkFeedbackQuestion Question;

    public com.sforce.soap.enterprise.sobject.WorkFeedbackQuestion getQuestion() {
      return Question;
    }

    public void setQuestion(com.sforce.soap.enterprise.sobject.WorkFeedbackQuestion Question) {
    ...
    /**
     * element : Request of type {urn:sobject.enterprise.soap.sforce.com}WorkFeedbackRequest
     * java type: com.sforce.soap.enterprise.sobject.WorkFeedbackRequest
     */
    private static final com.sforce.ws.bind.TypeInfo Request__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Request","urn:sobject.enterprise.soap.sforce.com","WorkFeedbackRequest",0,1,true);

    private boolean Request__is_set = false;

    private com.sforce.soap.enterprise.sobject.WorkFeedbackRequest Request;

    public com.sforce.soap.enterprise.sobject.WorkFeedbackRequest getRequest() {
      return Request;
    }

    public void setRequest(com.sforce.soap.enterprise.sobject.WorkFeedbackRequest Request) {
      this.Request = Request;
      Request__is_set = true;
    }

    /**
     * element : RequestId of type {urn:enterprise.soap.sforce.com}ID
     * java type: java.lang.String
     */
    private static final com.sforce.ws.bind.TypeInfo RequestId__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","RequestId","urn:enterprise.soap.sforce.com","ID",0,1,true);

    private boolean RequestId__is_set = false;
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "WorkFeedback");
    ...
    protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
       ...
       __typeMapper.writeString(__out, Feedback__typeInfo, Feedback, Feedback__is_set);
       ...
       __typeMapper.writeString(__out, RequestId__typeInfo, RequestId, RequestId__is_set);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, Feedback__typeInfo)) {
            setFeedback(__typeMapper.readString(__in, Feedback__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, Question__typeInfo)) {
            setQuestion((com.sforce.soap.enterprise.sobject.WorkFeedbackQuestion)__typeMapper.readObject(__in, Question__typeInfo, com.sforce.soap.enterprise.sobject.WorkFeedbackQuestion.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, Request__typeInfo)) {
            setRequest((com.sforce.soap.enterprise.sobject.WorkFeedbackRequest)__typeMapper.readObject(__in, Request__typeInfo, com.sforce.soap.enterprise.sobject.WorkFeedbackRequest.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, RequestId__typeInfo)) {
            setRequestId(__typeMapper.readString(__in, RequestId__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
    ...
    public String toString() {
      ...
      sb.append(" Feedback='").append(com.sforce.ws.util.Verbose.toString(Feedback)).append("'\n");
      ...
      sb.append(" Question='").append(com.sforce.ws.util.Verbose.toString(Question)).append("'\n");
      sb.append(" QuestionId='").append(com.sforce.ws.util.Verbose.toString(QuestionId)).append("'\n");
      sb.append(" Request='").append(com.sforce.ws.util.Verbose.toString(Request)).append("'\n");
      sb.append(" RequestId='").append(com.sforce.ws.util.Verbose.toString(RequestId)).append("'\n");
