...
public class CollaborationGroupMemberRequest extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append(" RequesterId='").append(com.sforce.ws.util.Verbose.toString(RequesterId)).append("'\n");
      sb.append(" ResponseMessage='").append(com.sforce.ws.util.Verbose.toString(ResponseMessage)).append("'\n");
