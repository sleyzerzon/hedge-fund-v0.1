...
public class ObjectPermissions extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append(" PermissionsCreate='").append(com.sforce.ws.util.Verbose.toString(PermissionsCreate)).append("'\n");
      sb.append(" PermissionsDelete='").append(com.sforce.ws.util.Verbose.toString(PermissionsDelete)).append("'\n");
      sb.append(" PermissionsEdit='").append(com.sforce.ws.util.Verbose.toString(PermissionsEdit)).append("'\n");
      sb.append(" PermissionsModifyAllRecords='").append(com.sforce.ws.util.Verbose.toString(PermissionsModifyAllRecords)).append("'\n");
      sb.append(" PermissionsRead='").append(com.sforce.ws.util.Verbose.toString(PermissionsRead)).append("'\n");
      sb.append(" PermissionsViewAllRecords='").append(com.sforce.ws.util.Verbose.toString(PermissionsViewAllRecords)).append("'\n");
