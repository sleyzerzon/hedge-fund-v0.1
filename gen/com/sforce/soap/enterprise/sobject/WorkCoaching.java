 ...
 */
public class WorkCoaching extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    /**
     * element : Coach of type {urn:sobject.enterprise.soap.sforce.com}User
     * java type: com.sforce.soap.enterprise.sobject.User
     */
    private static final com.sforce.ws.bind.TypeInfo Coach__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Coach","urn:sobject.enterprise.soap.sforce.com","User",0,1,true);

    private boolean Coach__is_set = false;

    private com.sforce.soap.enterprise.sobject.User Coach;

    public com.sforce.soap.enterprise.sobject.User getCoach() {
      return Coach;
    }

    public void setCoach(com.sforce.soap.enterprise.sobject.User Coach) {
      this.Coach = Coach;
      Coach__is_set = true;
    }

    /**
     * element : CoachId of type {urn:enterprise.soap.sforce.com}ID
     * java type: java.lang.String
     */
    private static final com.sforce.ws.bind.TypeInfo CoachId__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","CoachId","urn:enterprise.soap.sforce.com","ID",0,1,true);

    private boolean CoachId__is_set = false;
    ...
    public void setCoachId(java.lang.String CoachId) {
      this.CoachId = CoachId;
      CoachId__is_set = true;
    }

    /**
     * element : Coached of type {urn:sobject.enterprise.soap.sforce.com}User
     * java type: com.sforce.soap.enterprise.sobject.User
     */
    private static final com.sforce.ws.bind.TypeInfo Coached__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Coached","urn:sobject.enterprise.soap.sforce.com","User",0,1,true);

    private boolean Coached__is_set = false;

    private com.sforce.soap.enterprise.sobject.User Coached;

    public com.sforce.soap.enterprise.sobject.User getCoached() {
      return Coached;
    }

    public void setCoached(com.sforce.soap.enterprise.sobject.User Coached) {
      this.Coached = Coached;
      Coached__is_set = true;
    }

    /**
     * element : CoachedId of type {urn:enterprise.soap.sforce.com}ID
     * java type: java.lang.String
     */
    private static final com.sforce.ws.bind.TypeInfo CoachedId__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","CoachedId","urn:enterprise.soap.sforce.com","ID",0,1,true);

    private boolean CoachedId__is_set = false;

    private java.lang.String CoachedId;

    public java.lang.String getCoachedId() {
      return CoachedId;
    }

    public void setCoachedId(java.lang.String CoachedId) {
      this.CoachedId = CoachedId;
      CoachedId__is_set = true;
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "WorkCoaching");
    ...
    protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
       ...
       __typeMapper.writeObject(__out, Coach__typeInfo, Coach, Coach__is_set);
       __typeMapper.writeString(__out, CoachId__typeInfo, CoachId, CoachId__is_set);
       __typeMapper.writeObject(__out, Coached__typeInfo, Coached, Coached__is_set);
       __typeMapper.writeString(__out, CoachedId__typeInfo, CoachedId, CoachedId__is_set);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, Coach__typeInfo)) {
            setCoach((com.sforce.soap.enterprise.sobject.User)__typeMapper.readObject(__in, Coach__typeInfo, com.sforce.soap.enterprise.sobject.User.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, CoachId__typeInfo)) {
            setCoachId(__typeMapper.readString(__in, CoachId__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, Coached__typeInfo)) {
            setCoached((com.sforce.soap.enterprise.sobject.User)__typeMapper.readObject(__in, Coached__typeInfo, com.sforce.soap.enterprise.sobject.User.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, CoachedId__typeInfo)) {
            setCoachedId(__typeMapper.readString(__in, CoachedId__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
    ...
    public String toString() {
      ...
      sb.append(" Coach='").append(com.sforce.ws.util.Verbose.toString(Coach)).append("'\n");
      sb.append(" CoachId='").append(com.sforce.ws.util.Verbose.toString(CoachId)).append("'\n");
      sb.append(" Coached='").append(com.sforce.ws.util.Verbose.toString(Coached)).append("'\n");
      sb.append(" CoachedId='").append(com.sforce.ws.util.Verbose.toString(CoachedId)).append("'\n");
