...
public class EmailStatus extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append(" EmailTemplateName='").append(com.sforce.ws.util.Verbose.toString(EmailTemplateName)).append("'\n");
      sb.append(" FirstOpenDate='").append(com.sforce.ws.util.Verbose.toString(FirstOpenDate)).append("'\n");
      ...
      sb.append(" LastOpenDate='").append(com.sforce.ws.util.Verbose.toString(LastOpenDate)).append("'\n");
      sb.append(" Task='").append(com.sforce.ws.util.Verbose.toString(Task)).append("'\n");
      sb.append(" TaskId='").append(com.sforce.ws.util.Verbose.toString(TaskId)).append("'\n");
      sb.append(" TimesOpened='").append(com.sforce.ws.util.Verbose.toString(TimesOpened)).append("'\n");
