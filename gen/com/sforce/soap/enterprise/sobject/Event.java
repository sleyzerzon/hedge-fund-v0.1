...
public class Event extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    private static final com.sforce.ws.bind.TypeInfo What__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","What","urn:sobject.enterprise.soap.sforce.com","sObject",0,1,true);
    ...
    private static final com.sforce.ws.bind.TypeInfo Who__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Who","urn:sobject.enterprise.soap.sforce.com","sObject",0,1,true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.isElement(__in, What__typeInfo)) {
            setWhat((com.sforce.soap.enterprise.sobject.SObject)__typeMapper.readObject(__in, What__typeInfo, com.sforce.soap.enterprise.sobject.SObject.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, Who__typeInfo)) {
            setWho((com.sforce.soap.enterprise.sobject.SObject)__typeMapper.readObject(__in, Who__typeInfo, com.sforce.soap.enterprise.sobject.SObject.class));
        }
        __in.peekTag();
    ...
    public String toString() {
      ...
      sb.append(" ActivityDateTime='").append(com.sforce.ws.util.Verbose.toString(ActivityDateTime)).append("'\n");
      ...
      sb.append(" DurationInMinutes='").append(com.sforce.ws.util.Verbose.toString(DurationInMinutes)).append("'\n");
      sb.append(" EndDateTime='").append(com.sforce.ws.util.Verbose.toString(EndDateTime)).append("'\n");
      ...
      sb.append(" GroupEventType='").append(com.sforce.ws.util.Verbose.toString(GroupEventType)).append("'\n");
      sb.append(" IsAllDayEvent='").append(com.sforce.ws.util.Verbose.toString(IsAllDayEvent)).append("'\n");
      sb.append(" IsArchived='").append(com.sforce.ws.util.Verbose.toString(IsArchived)).append("'\n");
      sb.append(" IsChild='").append(com.sforce.ws.util.Verbose.toString(IsChild)).append("'\n");
      sb.append(" IsDeleted='").append(com.sforce.ws.util.Verbose.toString(IsDeleted)).append("'\n");
      sb.append(" IsGroupEvent='").append(com.sforce.ws.util.Verbose.toString(IsGroupEvent)).append("'\n");
      sb.append(" IsPrivate='").append(com.sforce.ws.util.Verbose.toString(IsPrivate)).append("'\n");
      sb.append(" IsRecurrence='").append(com.sforce.ws.util.Verbose.toString(IsRecurrence)).append("'\n");
      sb.append(" IsReminderSet='").append(com.sforce.ws.util.Verbose.toString(IsReminderSet)).append("'\n");
      ...
      sb.append(" RecurrenceActivityId='").append(com.sforce.ws.util.Verbose.toString(RecurrenceActivityId)).append("'\n");
      ...
      sb.append(" RecurrenceEndDateOnly='").append(com.sforce.ws.util.Verbose.toString(RecurrenceEndDateOnly)).append("'\n");
      ...
      sb.append(" RecurrenceStartDateTime='").append(com.sforce.ws.util.Verbose.toString(RecurrenceStartDateTime)).append("'\n");
      sb.append(" RecurrenceTimeZoneSidKey='").append(com.sforce.ws.util.Verbose.toString(RecurrenceTimeZoneSidKey)).append("'\n");
      sb.append(" RecurrenceType='").append(com.sforce.ws.util.Verbose.toString(RecurrenceType)).append("'\n");
      sb.append(" RecurringEvents='").append(com.sforce.ws.util.Verbose.toString(RecurringEvents)).append("'\n");
      sb.append(" ReminderDateTime='").append(com.sforce.ws.util.Verbose.toString(ReminderDateTime)).append("'\n");
      sb.append(" ShowAs='").append(com.sforce.ws.util.Verbose.toString(ShowAs)).append("'\n");
      sb.append(" StartDateTime='").append(com.sforce.ws.util.Verbose.toString(StartDateTime)).append("'\n");
      ...
      sb.append(" What='").append(com.sforce.ws.util.Verbose.toString(What)).append("'\n");
      sb.append(" WhatId='").append(com.sforce.ws.util.Verbose.toString(WhatId)).append("'\n");
      sb.append(" Who='").append(com.sforce.ws.util.Verbose.toString(Who)).append("'\n");
