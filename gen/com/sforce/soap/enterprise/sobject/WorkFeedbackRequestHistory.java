 ...
 */
public class WorkFeedbackRequestHistory extends com.sforce.soap.enterprise.sobject.SObject {

    /**
     * Constructor
     */
    public WorkFeedbackRequestHistory() {}
    ...
    /**
     * element : WorkFeedbackRequest of type {urn:sobject.enterprise.soap.sforce.com}WorkFeedbackRequest
     * java type: com.sforce.soap.enterprise.sobject.WorkFeedbackRequest
     */
    private static final com.sforce.ws.bind.TypeInfo WorkFeedbackRequest__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","WorkFeedbackRequest","urn:sobject.enterprise.soap.sforce.com","WorkFeedbackRequest",0,1,true);

    private boolean WorkFeedbackRequest__is_set = false;

    private com.sforce.soap.enterprise.sobject.WorkFeedbackRequest WorkFeedbackRequest;

    public com.sforce.soap.enterprise.sobject.WorkFeedbackRequest getWorkFeedbackRequest() {
      return WorkFeedbackRequest;
    }

    public void setWorkFeedbackRequest(com.sforce.soap.enterprise.sobject.WorkFeedbackRequest WorkFeedbackRequest) {
      this.WorkFeedbackRequest = WorkFeedbackRequest;
      WorkFeedbackRequest__is_set = true;
    }

    /**
     * element : WorkFeedbackRequestId of type {urn:enterprise.soap.sforce.com}ID
     * java type: java.lang.String
     */
    private static final com.sforce.ws.bind.TypeInfo WorkFeedbackRequestId__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","WorkFeedbackRequestId","urn:enterprise.soap.sforce.com","ID",0,1,true);

    private boolean WorkFeedbackRequestId__is_set = false;

    private java.lang.String WorkFeedbackRequestId;

    public java.lang.String getWorkFeedbackRequestId() {
      return WorkFeedbackRequestId;
    }

    public void setWorkFeedbackRequestId(java.lang.String WorkFeedbackRequestId) {
      this.WorkFeedbackRequestId = WorkFeedbackRequestId;
      WorkFeedbackRequestId__is_set = true;
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "WorkFeedbackRequestHistory");
    ...
    protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
       ...
       __typeMapper.writeObject(__out, WorkFeedbackRequest__typeInfo, WorkFeedbackRequest, WorkFeedbackRequest__is_set);
       __typeMapper.writeString(__out, WorkFeedbackRequestId__typeInfo, WorkFeedbackRequestId, WorkFeedbackRequestId__is_set);
    }
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, WorkFeedbackRequest__typeInfo)) {
            setWorkFeedbackRequest((com.sforce.soap.enterprise.sobject.WorkFeedbackRequest)__typeMapper.readObject(__in, WorkFeedbackRequest__typeInfo, com.sforce.soap.enterprise.sobject.WorkFeedbackRequest.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, WorkFeedbackRequestId__typeInfo)) {
            setWorkFeedbackRequestId(__typeMapper.readString(__in, WorkFeedbackRequestId__typeInfo, java.lang.String.class));
        }
    }
    ...
    public String toString() {
      ...
      sb.append("[WorkFeedbackRequestHistory ");
      ...
      sb.append(" WorkFeedbackRequest='").append(com.sforce.ws.util.Verbose.toString(WorkFeedbackRequest)).append("'\n");
      sb.append(" WorkFeedbackRequestId='").append(com.sforce.ws.util.Verbose.toString(WorkFeedbackRequestId)).append("'\n");
      sb.append("]\n");
      return sb.toString();
    }
