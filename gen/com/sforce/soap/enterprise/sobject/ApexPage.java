...
public class ApexPage extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append(" ControllerKey='").append(com.sforce.ws.util.Verbose.toString(ControllerKey)).append("'\n");
      sb.append(" ControllerType='").append(com.sforce.ws.util.Verbose.toString(ControllerType)).append("'\n");
      ...
      sb.append(" IsConfirmationTokenRequired='").append(com.sforce.ws.util.Verbose.toString(IsConfirmationTokenRequired)).append("'\n");
