 ...
 */
public class WorkGoalCollaboratorHistory extends com.sforce.soap.enterprise.sobject.SObject {

    /**
     * Constructor
     */
    public WorkGoalCollaboratorHistory() {}
    ...
    /**
     * element : WorkGoalCollaborator of type {urn:sobject.enterprise.soap.sforce.com}WorkGoalCollaborator
     * java type: com.sforce.soap.enterprise.sobject.WorkGoalCollaborator
     */
    private static final com.sforce.ws.bind.TypeInfo WorkGoalCollaborator__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","WorkGoalCollaborator","urn:sobject.enterprise.soap.sforce.com","WorkGoalCollaborator",0,1,true);

    private boolean WorkGoalCollaborator__is_set = false;

    private com.sforce.soap.enterprise.sobject.WorkGoalCollaborator WorkGoalCollaborator;

    public com.sforce.soap.enterprise.sobject.WorkGoalCollaborator getWorkGoalCollaborator() {
      return WorkGoalCollaborator;
    }

    public void setWorkGoalCollaborator(com.sforce.soap.enterprise.sobject.WorkGoalCollaborator WorkGoalCollaborator) {
      this.WorkGoalCollaborator = WorkGoalCollaborator;
      WorkGoalCollaborator__is_set = true;
    }

    /**
     * element : WorkGoalCollaboratorId of type {urn:enterprise.soap.sforce.com}ID
     * java type: java.lang.String
     */
    private static final com.sforce.ws.bind.TypeInfo WorkGoalCollaboratorId__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","WorkGoalCollaboratorId","urn:enterprise.soap.sforce.com","ID",0,1,true);

    private boolean WorkGoalCollaboratorId__is_set = false;

    private java.lang.String WorkGoalCollaboratorId;

    public java.lang.String getWorkGoalCollaboratorId() {
      return WorkGoalCollaboratorId;
    }

    public void setWorkGoalCollaboratorId(java.lang.String WorkGoalCollaboratorId) {
      this.WorkGoalCollaboratorId = WorkGoalCollaboratorId;
      WorkGoalCollaboratorId__is_set = true;
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "WorkGoalCollaboratorHistory");
    ...
    protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
       ...
       __typeMapper.writeObject(__out, WorkGoalCollaborator__typeInfo, WorkGoalCollaborator, WorkGoalCollaborator__is_set);
       __typeMapper.writeString(__out, WorkGoalCollaboratorId__typeInfo, WorkGoalCollaboratorId, WorkGoalCollaboratorId__is_set);
    }
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, WorkGoalCollaborator__typeInfo)) {
            setWorkGoalCollaborator((com.sforce.soap.enterprise.sobject.WorkGoalCollaborator)__typeMapper.readObject(__in, WorkGoalCollaborator__typeInfo, com.sforce.soap.enterprise.sobject.WorkGoalCollaborator.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, WorkGoalCollaboratorId__typeInfo)) {
            setWorkGoalCollaboratorId(__typeMapper.readString(__in, WorkGoalCollaboratorId__typeInfo, java.lang.String.class));
        }
    }
    ...
    public String toString() {
      ...
      sb.append("[WorkGoalCollaboratorHistory ");
      ...
      sb.append(" WorkGoalCollaborator='").append(com.sforce.ws.util.Verbose.toString(WorkGoalCollaborator)).append("'\n");
      sb.append(" WorkGoalCollaboratorId='").append(com.sforce.ws.util.Verbose.toString(WorkGoalCollaboratorId)).append("'\n");
      sb.append("]\n");
      return sb.toString();
    }
