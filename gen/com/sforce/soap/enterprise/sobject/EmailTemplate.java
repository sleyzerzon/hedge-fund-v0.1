...
public class EmailTemplate extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append(" BrandTemplateId='").append(com.sforce.ws.util.Verbose.toString(BrandTemplateId)).append("'\n");
      ...
      sb.append(" HtmlValue='").append(com.sforce.ws.util.Verbose.toString(HtmlValue)).append("'\n");
      ...
      sb.append(" TemplateStyle='").append(com.sforce.ws.util.Verbose.toString(TemplateStyle)).append("'\n");
