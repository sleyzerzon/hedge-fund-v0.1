...
public class CaseTeamMember extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    private static final com.sforce.ws.bind.TypeInfo Member__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Member","urn:sobject.enterprise.soap.sforce.com","sObject",0,1,true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.isElement(__in, Member__typeInfo)) {
            setMember((com.sforce.soap.enterprise.sobject.SObject)__typeMapper.readObject(__in, Member__typeInfo, com.sforce.soap.enterprise.sobject.SObject.class));
        }
        __in.peekTag();
    ...
    public String toString() {
      ...
      sb.append(" TeamRole='").append(com.sforce.ws.util.Verbose.toString(TeamRole)).append("'\n");
      sb.append(" TeamRoleId='").append(com.sforce.ws.util.Verbose.toString(TeamRoleId)).append("'\n");
      sb.append(" TeamTemplateMember='").append(com.sforce.ws.util.Verbose.toString(TeamTemplateMember)).append("'\n");
      sb.append(" TeamTemplateMemberId='").append(com.sforce.ws.util.Verbose.toString(TeamTemplateMemberId)).append("'\n");
      sb.append("]\n");
      return sb.toString();
    }
