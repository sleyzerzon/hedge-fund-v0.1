...
public class SetupEntityAccess extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append(super.toString());sb.append(" Parent='").append(com.sforce.ws.util.Verbose.toString(Parent)).append("'\n");
      sb.append(" ParentId='").append(com.sforce.ws.util.Verbose.toString(ParentId)).append("'\n");
      sb.append(" SetupEntityId='").append(com.sforce.ws.util.Verbose.toString(SetupEntityId)).append("'\n");
      sb.append(" SetupEntityType='").append(com.sforce.ws.util.Verbose.toString(SetupEntityType)).append("'\n");
