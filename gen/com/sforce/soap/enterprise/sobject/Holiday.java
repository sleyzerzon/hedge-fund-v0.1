...
public class Holiday extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append("[Holiday ");
      sb.append(super.toString());sb.append(" ActivityDate='").append(com.sforce.ws.util.Verbose.toString(ActivityDate)).append("'\n");
      ...
      sb.append(" EndTimeInMinutes='").append(com.sforce.ws.util.Verbose.toString(EndTimeInMinutes)).append("'\n");
      sb.append(" IsAllDay='").append(com.sforce.ws.util.Verbose.toString(IsAllDay)).append("'\n");
      ...
      sb.append(" StartTimeInMinutes='").append(com.sforce.ws.util.Verbose.toString(StartTimeInMinutes)).append("'\n");
