 ...
 */
public class WorkPerformanceCycleHistory extends com.sforce.soap.enterprise.sobject.SObject {

    /**
     * Constructor
     */
    public WorkPerformanceCycleHistory() {}
    ...
    /**
     * element : WorkPerformanceCycle of type {urn:sobject.enterprise.soap.sforce.com}WorkPerformanceCycle
     * java type: com.sforce.soap.enterprise.sobject.WorkPerformanceCycle
     */
    private static final com.sforce.ws.bind.TypeInfo WorkPerformanceCycle__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","WorkPerformanceCycle","urn:sobject.enterprise.soap.sforce.com","WorkPerformanceCycle",0,1,true);

    private boolean WorkPerformanceCycle__is_set = false;

    private com.sforce.soap.enterprise.sobject.WorkPerformanceCycle WorkPerformanceCycle;

    public com.sforce.soap.enterprise.sobject.WorkPerformanceCycle getWorkPerformanceCycle() {
      return WorkPerformanceCycle;
    }

    public void setWorkPerformanceCycle(com.sforce.soap.enterprise.sobject.WorkPerformanceCycle WorkPerformanceCycle) {
      this.WorkPerformanceCycle = WorkPerformanceCycle;
      WorkPerformanceCycle__is_set = true;
    }

    /**
     * element : WorkPerformanceCycleId of type {urn:enterprise.soap.sforce.com}ID
     * java type: java.lang.String
     */
    private static final com.sforce.ws.bind.TypeInfo WorkPerformanceCycleId__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","WorkPerformanceCycleId","urn:enterprise.soap.sforce.com","ID",0,1,true);

    private boolean WorkPerformanceCycleId__is_set = false;

    private java.lang.String WorkPerformanceCycleId;

    public java.lang.String getWorkPerformanceCycleId() {
      return WorkPerformanceCycleId;
    }

    public void setWorkPerformanceCycleId(java.lang.String WorkPerformanceCycleId) {
      this.WorkPerformanceCycleId = WorkPerformanceCycleId;
      WorkPerformanceCycleId__is_set = true;
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "WorkPerformanceCycleHistory");
    ...
    protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
       ...
       __typeMapper.writeObject(__out, WorkPerformanceCycle__typeInfo, WorkPerformanceCycle, WorkPerformanceCycle__is_set);
       __typeMapper.writeString(__out, WorkPerformanceCycleId__typeInfo, WorkPerformanceCycleId, WorkPerformanceCycleId__is_set);
    }
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, WorkPerformanceCycle__typeInfo)) {
            setWorkPerformanceCycle((com.sforce.soap.enterprise.sobject.WorkPerformanceCycle)__typeMapper.readObject(__in, WorkPerformanceCycle__typeInfo, com.sforce.soap.enterprise.sobject.WorkPerformanceCycle.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, WorkPerformanceCycleId__typeInfo)) {
            setWorkPerformanceCycleId(__typeMapper.readString(__in, WorkPerformanceCycleId__typeInfo, java.lang.String.class));
        }
    }
    ...
    public String toString() {
      ...
      sb.append("[WorkPerformanceCycleHistory ");
      ...
      sb.append(" WorkPerformanceCycle='").append(com.sforce.ws.util.Verbose.toString(WorkPerformanceCycle)).append("'\n");
      sb.append(" WorkPerformanceCycleId='").append(com.sforce.ws.util.Verbose.toString(WorkPerformanceCycleId)).append("'\n");
      sb.append("]\n");
      return sb.toString();
    }
