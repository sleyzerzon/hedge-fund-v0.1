...
public class ApexTestResult extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append(" ApexLog='").append(com.sforce.ws.util.Verbose.toString(ApexLog)).append("'\n");
      sb.append(" ApexLogId='").append(com.sforce.ws.util.Verbose.toString(ApexLogId)).append("'\n");
      sb.append(" AsyncApexJob='").append(com.sforce.ws.util.Verbose.toString(AsyncApexJob)).append("'\n");
      sb.append(" AsyncApexJobId='").append(com.sforce.ws.util.Verbose.toString(AsyncApexJobId)).append("'\n");
      ...
      sb.append(" Outcome='").append(com.sforce.ws.util.Verbose.toString(Outcome)).append("'\n");
      sb.append(" QueueItem='").append(com.sforce.ws.util.Verbose.toString(QueueItem)).append("'\n");
      sb.append(" QueueItemId='").append(com.sforce.ws.util.Verbose.toString(QueueItemId)).append("'\n");
      ...
      sb.append(" TestTimestamp='").append(com.sforce.ws.util.Verbose.toString(TestTimestamp)).append("'\n");
      sb.append("]\n");
      return sb.toString();
    }
