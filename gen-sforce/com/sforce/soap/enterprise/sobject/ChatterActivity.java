...
public class ChatterActivity extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append(super.toString());sb.append(" CommentCount='").append(com.sforce.ws.util.Verbose.toString(CommentCount)).append("'\n");
      sb.append(" CommentReceivedCount='").append(com.sforce.ws.util.Verbose.toString(CommentReceivedCount)).append("'\n");
      sb.append(" InfluenceRawRank='").append(com.sforce.ws.util.Verbose.toString(InfluenceRawRank)).append("'\n");
      sb.append(" LikeReceivedCount='").append(com.sforce.ws.util.Verbose.toString(LikeReceivedCount)).append("'\n");
      ...
      sb.append(" PostCount='").append(com.sforce.ws.util.Verbose.toString(PostCount)).append("'\n");
