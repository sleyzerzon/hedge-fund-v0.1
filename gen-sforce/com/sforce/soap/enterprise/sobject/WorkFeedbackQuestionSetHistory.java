 ...
 */
public class WorkFeedbackQuestionSetHistory extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    /**
     * element : WorkFeedbackQuestionSet of type {urn:sobject.enterprise.soap.sforce.com}WorkFeedbackQuestionSet
     * java type: com.sforce.soap.enterprise.sobject.WorkFeedbackQuestionSet
     */
    private static final com.sforce.ws.bind.TypeInfo WorkFeedbackQuestionSet__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","WorkFeedbackQuestionSet","urn:sobject.enterprise.soap.sforce.com","WorkFeedbackQuestionSet",0,1,true);

    private boolean WorkFeedbackQuestionSet__is_set = false;

    private com.sforce.soap.enterprise.sobject.WorkFeedbackQuestionSet WorkFeedbackQuestionSet;

    public com.sforce.soap.enterprise.sobject.WorkFeedbackQuestionSet getWorkFeedbackQuestionSet() {
      return WorkFeedbackQuestionSet;
    }

    public void setWorkFeedbackQuestionSet(com.sforce.soap.enterprise.sobject.WorkFeedbackQuestionSet WorkFeedbackQuestionSet) {
      this.WorkFeedbackQuestionSet = WorkFeedbackQuestionSet;
      WorkFeedbackQuestionSet__is_set = true;
    }

    /**
     * element : WorkFeedbackQuestionSetId of type {urn:enterprise.soap.sforce.com}ID
     * java type: java.lang.String
     */
    private static final com.sforce.ws.bind.TypeInfo WorkFeedbackQuestionSetId__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","WorkFeedbackQuestionSetId","urn:enterprise.soap.sforce.com","ID",0,1,true);

    private boolean WorkFeedbackQuestionSetId__is_set = false;

    private java.lang.String WorkFeedbackQuestionSetId;

    public java.lang.String getWorkFeedbackQuestionSetId() {
      return WorkFeedbackQuestionSetId;
    }

    public void setWorkFeedbackQuestionSetId(java.lang.String WorkFeedbackQuestionSetId) {
      this.WorkFeedbackQuestionSetId = WorkFeedbackQuestionSetId;
      WorkFeedbackQuestionSetId__is_set = true;
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "WorkFeedbackQuestionSetHistory");
    ...
    protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
       ...
       __typeMapper.writeObject(__out, WorkFeedbackQuestionSet__typeInfo, WorkFeedbackQuestionSet, WorkFeedbackQuestionSet__is_set);
       __typeMapper.writeString(__out, WorkFeedbackQuestionSetId__typeInfo, WorkFeedbackQuestionSetId, WorkFeedbackQuestionSetId__is_set);
    }
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, WorkFeedbackQuestionSet__typeInfo)) {
            setWorkFeedbackQuestionSet((com.sforce.soap.enterprise.sobject.WorkFeedbackQuestionSet)__typeMapper.readObject(__in, WorkFeedbackQuestionSet__typeInfo, com.sforce.soap.enterprise.sobject.WorkFeedbackQuestionSet.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, WorkFeedbackQuestionSetId__typeInfo)) {
            setWorkFeedbackQuestionSetId(__typeMapper.readString(__in, WorkFeedbackQuestionSetId__typeInfo, java.lang.String.class));
        }
    }
    ...
    public String toString() {
      ...
      sb.append("[WorkFeedbackQuestionSetHistory ");
      ...
      sb.append(" WorkFeedbackQuestionSet='").append(com.sforce.ws.util.Verbose.toString(WorkFeedbackQuestionSet)).append("'\n");
      sb.append(" WorkFeedbackQuestionSetId='").append(com.sforce.ws.util.Verbose.toString(WorkFeedbackQuestionSetId)).append("'\n");
      sb.append("]\n");
      return sb.toString();
    }
