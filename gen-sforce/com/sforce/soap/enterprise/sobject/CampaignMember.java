...
public class CampaignMember extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append(super.toString());sb.append(" Campaign='").append(com.sforce.ws.util.Verbose.toString(Campaign)).append("'\n");
      ...
      sb.append(" FirstRespondedDate='").append(com.sforce.ws.util.Verbose.toString(FirstRespondedDate)).append("'\n");
      sb.append(" HasResponded='").append(com.sforce.ws.util.Verbose.toString(HasResponded)).append("'\n");
