...
public class GroupMember extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append(super.toString());sb.append(" Group='").append(com.sforce.ws.util.Verbose.toString(Group)).append("'\n");
      sb.append(" GroupId='").append(com.sforce.ws.util.Verbose.toString(GroupId)).append("'\n");
