...
public class MacroHistory extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.isElement(__in, MacroId__typeInfo)) {
            setMacroId(__typeMapper.readString(__in, MacroId__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
    ...
    public String toString() {
      ...
      sb.append(" Macro='").append(com.sforce.ws.util.Verbose.toString(Macro)).append("'\n");
      sb.append(" MacroId='").append(com.sforce.ws.util.Verbose.toString(MacroId)).append("'\n");
