...
public class LookedUpFromActivity extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append(" ActivityType='").append(com.sforce.ws.util.Verbose.toString(ActivityType)).append("'\n");
      ...
      sb.append(" IsTask='").append(com.sforce.ws.util.Verbose.toString(IsTask)).append("'\n");
      sb.append(" IsVisibleInSelfService='").append(com.sforce.ws.util.Verbose.toString(IsVisibleInSelfService)).append("'\n");
