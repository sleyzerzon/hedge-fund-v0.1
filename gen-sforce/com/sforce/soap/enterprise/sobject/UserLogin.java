...
public class UserLogin extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append("[UserLogin ");
      sb.append(super.toString());sb.append(" IsFrozen='").append(com.sforce.ws.util.Verbose.toString(IsFrozen)).append("'\n");
      sb.append(" IsPasswordLocked='").append(com.sforce.ws.util.Verbose.toString(IsPasswordLocked)).append("'\n");
