...
public class OrderItemHistory extends com.sforce.soap.enterprise.sobject.SObject {
     ...
     */
    private static final com.sforce.ws.bind.TypeInfo OrderItem__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","OrderItem","urn:sobject.enterprise.soap.sforce.com","OrderItem",0,1,true);
     ...
     * java type: java.lang.String
     */
    private static final com.sforce.ws.bind.TypeInfo OrderItemId__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","OrderItemId","urn:enterprise.soap.sforce.com","ID",0,1,true);
    ...
    protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
       ...
       __typeMapper.writeObject(__out, OrderItem__typeInfo, OrderItem, OrderItem__is_set);
       __typeMapper.writeString(__out, OrderItemId__typeInfo, OrderItemId, OrderItemId__is_set);
    }
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, OrderItem__typeInfo)) {
            setOrderItem((com.sforce.soap.enterprise.sobject.OrderItem)__typeMapper.readObject(__in, OrderItem__typeInfo, com.sforce.soap.enterprise.sobject.OrderItem.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, OrderItemId__typeInfo)) {
            setOrderItemId(__typeMapper.readString(__in, OrderItemId__typeInfo, java.lang.String.class));
        }
    }
    ...
    public String toString() {
      ...
      sb.append(" OrderItem='").append(com.sforce.ws.util.Verbose.toString(OrderItem)).append("'\n");
      sb.append(" OrderItemId='").append(com.sforce.ws.util.Verbose.toString(OrderItemId)).append("'\n");
      sb.append("]\n");
      return sb.toString();
    }
