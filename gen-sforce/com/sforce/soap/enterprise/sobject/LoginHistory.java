...
public class LoginHistory extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append(super.toString());sb.append(" ApiType='").append(com.sforce.ws.util.Verbose.toString(ApiType)).append("'\n");
      ...
      sb.append(" Browser='").append(com.sforce.ws.util.Verbose.toString(Browser)).append("'\n");
      sb.append(" ClientVersion='").append(com.sforce.ws.util.Verbose.toString(ClientVersion)).append("'\n");
      sb.append(" LoginTime='").append(com.sforce.ws.util.Verbose.toString(LoginTime)).append("'\n");
      ...
      sb.append(" Platform='").append(com.sforce.ws.util.Verbose.toString(Platform)).append("'\n");
