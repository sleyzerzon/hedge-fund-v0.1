...
public class CaseShare extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append("[CaseShare ");
      sb.append(super.toString());sb.append(" Case='").append(com.sforce.ws.util.Verbose.toString(Case)).append("'\n");
      sb.append(" CaseAccessLevel='").append(com.sforce.ws.util.Verbose.toString(CaseAccessLevel)).append("'\n");
      sb.append(" CaseId='").append(com.sforce.ws.util.Verbose.toString(CaseId)).append("'\n");
