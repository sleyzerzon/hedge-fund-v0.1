 ...
 */
public class Cloud__c extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    /**
     * element : Access_Key__c of type {http://www.w3.org/2001/XMLSchema}string
     * java type: java.lang.String
     */
    private static final com.sforce.ws.bind.TypeInfo Access_Key__c__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Access_Key__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

    private boolean Access_Key__c__is_set = false;

    private java.lang.String Access_Key__c;

    public java.lang.String getAccess_Key__c() {
      return Access_Key__c;
    }

    public void setAccess_Key__c(java.lang.String Access_Key__c) {
      this.Access_Key__c = Access_Key__c;
      Access_Key__c__is_set = true;
    }
    ...
    /**
     * element : KeyPath__c of type {http://www.w3.org/2001/XMLSchema}string
     * java type: java.lang.String
     */
    private static final com.sforce.ws.bind.TypeInfo KeyPath__c__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","KeyPath__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

    private boolean KeyPath__c__is_set = false;

    private java.lang.String KeyPath__c;

    public java.lang.String getKeyPath__c() {
      return KeyPath__c;
    }

    public void setKeyPath__c(java.lang.String KeyPath__c) {
      this.KeyPath__c = KeyPath__c;
      KeyPath__c__is_set = true;
    }
    ...
    /**
     * element : Markets__r of type {urn:enterprise.soap.sforce.com}QueryResult
     * java type: com.sforce.soap.enterprise.QueryResult
     */
    private static final com.sforce.ws.bind.TypeInfo Markets__r__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Markets__r","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);

    private boolean Markets__r__is_set = false;

    private com.sforce.soap.enterprise.QueryResult Markets__r;

    public com.sforce.soap.enterprise.QueryResult getMarkets__r() {
      return Markets__r;
    }

    public void setMarkets__r(com.sforce.soap.enterprise.QueryResult Markets__r) {
      this.Markets__r = Markets__r;
      Markets__r__is_set = true;
    }
    ...
    /**
     * element : Password__c of type {http://www.w3.org/2001/XMLSchema}string
     * java type: java.lang.String
     */
    private static final com.sforce.ws.bind.TypeInfo Password__c__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Password__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

    private boolean Password__c__is_set = false;
    ...
    /**
     * element : Provider__c of type {http://www.w3.org/2001/XMLSchema}string
     * java type: java.lang.String
     */
    private static final com.sforce.ws.bind.TypeInfo Provider__c__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Provider__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

    private boolean Provider__c__is_set = false;

    private java.lang.String Provider__c;

    public java.lang.String getProvider__c() {
      return Provider__c;
    }

    public void setProvider__c(java.lang.String Provider__c) {
      this.Provider__c = Provider__c;
      Provider__c__is_set = true;
    }

    /**
     * element : Secret_Key__c of type {http://www.w3.org/2001/XMLSchema}string
     * java type: java.lang.String
     */
    private static final com.sforce.ws.bind.TypeInfo Secret_Key__c__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Secret_Key__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

    private boolean Secret_Key__c__is_set = false;

    private java.lang.String Secret_Key__c;

    public java.lang.String getSecret_Key__c() {
      return Secret_Key__c;
    }

    public void setSecret_Key__c(java.lang.String Secret_Key__c) {
      this.Secret_Key__c = Secret_Key__c;
      Secret_Key__c__is_set = true;
    }
    ...
    /**
     * element : User__c of type {http://www.w3.org/2001/XMLSchema}string
     * java type: java.lang.String
     */
    private static final com.sforce.ws.bind.TypeInfo User__c__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","User__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Cloud__c");
    ...
    protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
       ...
       __typeMapper.writeString(__out, Access_Key__c__typeInfo, Access_Key__c, Access_Key__c__is_set);
       ...
       __typeMapper.writeString(__out, KeyPath__c__typeInfo, KeyPath__c, KeyPath__c__is_set);
       ...
       __typeMapper.writeString(__out, Password__c__typeInfo, Password__c, Password__c__is_set);
       ...
       __typeMapper.writeString(__out, Provider__c__typeInfo, Provider__c, Provider__c__is_set);
       __typeMapper.writeString(__out, Secret_Key__c__typeInfo, Secret_Key__c, Secret_Key__c__is_set);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, Access_Key__c__typeInfo)) {
            setAccess_Key__c(__typeMapper.readString(__in, Access_Key__c__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, KeyPath__c__typeInfo)) {
            setKeyPath__c(__typeMapper.readString(__in, KeyPath__c__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, Markets__r__typeInfo)) {
            setMarkets__r((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, Markets__r__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
        }
        __in.peekTag();
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, Password__c__typeInfo)) {
            setPassword__c(__typeMapper.readString(__in, Password__c__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, Provider__c__typeInfo)) {
            setProvider__c(__typeMapper.readString(__in, Provider__c__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, Secret_Key__c__typeInfo)) {
            setSecret_Key__c(__typeMapper.readString(__in, Secret_Key__c__typeInfo, java.lang.String.class));
        }
        __in.peekTag();
    ...
    public String toString() {
      ...
      sb.append("[Cloud__c ");
      sb.append(super.toString());sb.append(" Access_Key__c='").append(com.sforce.ws.util.Verbose.toString(Access_Key__c)).append("'\n");
      sb.append(" Account__c='").append(com.sforce.ws.util.Verbose.toString(Account__c)).append("'\n");
      sb.append(" Account__r='").append(com.sforce.ws.util.Verbose.toString(Account__r)).append("'\n");
      ...
      sb.append(" KeyPath__c='").append(com.sforce.ws.util.Verbose.toString(KeyPath__c)).append("'\n");
      ...
      sb.append(" Password__c='").append(com.sforce.ws.util.Verbose.toString(Password__c)).append("'\n");
      ...
      sb.append(" Provider__c='").append(com.sforce.ws.util.Verbose.toString(Provider__c)).append("'\n");
      sb.append(" Secret_Key__c='").append(com.sforce.ws.util.Verbose.toString(Secret_Key__c)).append("'\n");
      ...
      sb.append(" User__c='").append(com.sforce.ws.util.Verbose.toString(User__c)).append("'\n");
      sb.append("]\n");
      return sb.toString();
    }
