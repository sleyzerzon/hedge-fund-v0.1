...
public class FeedItem extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    private static final com.sforce.ws.bind.TypeInfo InsertedBy__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","InsertedBy","urn:sobject.enterprise.soap.sforce.com","sObject",0,1,true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        if (__typeMapper.isElement(__in, InsertedBy__typeInfo)) {
            setInsertedBy((com.sforce.soap.enterprise.sobject.SObject)__typeMapper.readObject(__in, InsertedBy__typeInfo, com.sforce.soap.enterprise.sobject.SObject.class));
        }
        __in.peekTag();
    ...
    public String toString() {
      ...
      sb.append(" CommentCount='").append(com.sforce.ws.util.Verbose.toString(CommentCount)).append("'\n");
      sb.append(" ContentData='").append(com.sforce.ws.util.Verbose.toString(ContentData)).append("'\n");
      sb.append(" ContentDescription='").append(com.sforce.ws.util.Verbose.toString(ContentDescription)).append("'\n");
      sb.append(" ContentFileName='").append(com.sforce.ws.util.Verbose.toString(ContentFileName)).append("'\n");
      ...
      sb.append(" FeedComments='").append(com.sforce.ws.util.Verbose.toString(FeedComments)).append("'\n");
      sb.append(" FeedLikes='").append(com.sforce.ws.util.Verbose.toString(FeedLikes)).append("'\n");
      sb.append(" FeedTrackedChanges='").append(com.sforce.ws.util.Verbose.toString(FeedTrackedChanges)).append("'\n");
      ...
      sb.append(" LikeCount='").append(com.sforce.ws.util.Verbose.toString(LikeCount)).append("'\n");
      sb.append(" LinkUrl='").append(com.sforce.ws.util.Verbose.toString(LinkUrl)).append("'\n");
      sb.append(" NetworkScope='").append(com.sforce.ws.util.Verbose.toString(NetworkScope)).append("'\n");
