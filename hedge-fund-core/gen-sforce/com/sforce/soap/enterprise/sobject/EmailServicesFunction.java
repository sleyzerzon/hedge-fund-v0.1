...
public class EmailServicesFunction extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append(super.toString());sb.append(" AddressInactiveAction='").append(com.sforce.ws.util.Verbose.toString(AddressInactiveAction)).append("'\n");
      sb.append(" Addresses='").append(com.sforce.ws.util.Verbose.toString(Addresses)).append("'\n");
      sb.append(" ApexClassId='").append(com.sforce.ws.util.Verbose.toString(ApexClassId)).append("'\n");
      sb.append(" AttachmentOption='").append(com.sforce.ws.util.Verbose.toString(AttachmentOption)).append("'\n");
      sb.append(" AuthenticationFailureAction='").append(com.sforce.ws.util.Verbose.toString(AuthenticationFailureAction)).append("'\n");
      sb.append(" AuthorizationFailureAction='").append(com.sforce.ws.util.Verbose.toString(AuthorizationFailureAction)).append("'\n");
      ...
      sb.append(" ErrorRoutingAddress='").append(com.sforce.ws.util.Verbose.toString(ErrorRoutingAddress)).append("'\n");
      sb.append(" FunctionInactiveAction='").append(com.sforce.ws.util.Verbose.toString(FunctionInactiveAction)).append("'\n");
      sb.append(" FunctionName='").append(com.sforce.ws.util.Verbose.toString(FunctionName)).append("'\n");
      sb.append(" IsActive='").append(com.sforce.ws.util.Verbose.toString(IsActive)).append("'\n");
      sb.append(" IsAuthenticationRequired='").append(com.sforce.ws.util.Verbose.toString(IsAuthenticationRequired)).append("'\n");
      sb.append(" IsErrorRoutingEnabled='").append(com.sforce.ws.util.Verbose.toString(IsErrorRoutingEnabled)).append("'\n");
      sb.append(" IsTextAttachmentsAsBinary='").append(com.sforce.ws.util.Verbose.toString(IsTextAttachmentsAsBinary)).append("'\n");
      sb.append(" IsTlsRequired='").append(com.sforce.ws.util.Verbose.toString(IsTlsRequired)).append("'\n");
      ...
      sb.append(" OverLimitAction='").append(com.sforce.ws.util.Verbose.toString(OverLimitAction)).append("'\n");
