...
public class EmailServicesAddress extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append(super.toString());sb.append(" AuthorizedSenders='").append(com.sforce.ws.util.Verbose.toString(AuthorizedSenders)).append("'\n");
      ...
      sb.append(" EmailDomainName='").append(com.sforce.ws.util.Verbose.toString(EmailDomainName)).append("'\n");
      sb.append(" Function='").append(com.sforce.ws.util.Verbose.toString(Function)).append("'\n");
      sb.append(" FunctionId='").append(com.sforce.ws.util.Verbose.toString(FunctionId)).append("'\n");
      ...
      sb.append(" LocalPart='").append(com.sforce.ws.util.Verbose.toString(LocalPart)).append("'\n");
      sb.append(" RunAsUserId='").append(com.sforce.ws.util.Verbose.toString(RunAsUserId)).append("'\n");
