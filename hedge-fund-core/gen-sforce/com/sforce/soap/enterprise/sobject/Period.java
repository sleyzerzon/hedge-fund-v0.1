...
public class Period extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append("[Period ");
      sb.append(super.toString());sb.append(" EndDate='").append(com.sforce.ws.util.Verbose.toString(EndDate)).append("'\n");
      sb.append(" FiscalYearSettings='").append(com.sforce.ws.util.Verbose.toString(FiscalYearSettings)).append("'\n");
      sb.append(" FiscalYearSettingsId='").append(com.sforce.ws.util.Verbose.toString(FiscalYearSettingsId)).append("'\n");
      sb.append(" IsForecastPeriod='").append(com.sforce.ws.util.Verbose.toString(IsForecastPeriod)).append("'\n");
      sb.append(" Number='").append(com.sforce.ws.util.Verbose.toString(Number)).append("'\n");
      sb.append(" PeriodLabel='").append(com.sforce.ws.util.Verbose.toString(PeriodLabel)).append("'\n");
      sb.append(" QuarterLabel='").append(com.sforce.ws.util.Verbose.toString(QuarterLabel)).append("'\n");
