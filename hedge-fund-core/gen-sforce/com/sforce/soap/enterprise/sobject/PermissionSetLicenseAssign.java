...
public class PermissionSetLicenseAssign extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append(super.toString());sb.append(" Assignee='").append(com.sforce.ws.util.Verbose.toString(Assignee)).append("'\n");
      sb.append(" AssigneeId='").append(com.sforce.ws.util.Verbose.toString(AssigneeId)).append("'\n");
      ...
      sb.append(" PermissionSetLicense='").append(com.sforce.ws.util.Verbose.toString(PermissionSetLicense)).append("'\n");
      sb.append(" PermissionSetLicenseId='").append(com.sforce.ws.util.Verbose.toString(PermissionSetLicenseId)).append("'\n");
