...
public class Campaign extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append(" ActualCost='").append(com.sforce.ws.util.Verbose.toString(ActualCost)).append("'\n");
      sb.append(" AmountAllOpportunities='").append(com.sforce.ws.util.Verbose.toString(AmountAllOpportunities)).append("'\n");
      sb.append(" AmountWonOpportunities='").append(com.sforce.ws.util.Verbose.toString(AmountWonOpportunities)).append("'\n");
      ...
      sb.append(" BudgetedCost='").append(com.sforce.ws.util.Verbose.toString(BudgetedCost)).append("'\n");
      sb.append(" CampaignMemberRecordType='").append(com.sforce.ws.util.Verbose.toString(CampaignMemberRecordType)).append("'\n");
      sb.append(" CampaignMemberRecordTypeId='").append(com.sforce.ws.util.Verbose.toString(CampaignMemberRecordTypeId)).append("'\n");
      sb.append(" CampaignMembers='").append(com.sforce.ws.util.Verbose.toString(CampaignMembers)).append("'\n");
      sb.append(" ChildCampaigns='").append(com.sforce.ws.util.Verbose.toString(ChildCampaigns)).append("'\n");
      ...
      sb.append(" ExpectedResponse='").append(com.sforce.ws.util.Verbose.toString(ExpectedResponse)).append("'\n");
      ...
      sb.append(" NumberOfContacts='").append(com.sforce.ws.util.Verbose.toString(NumberOfContacts)).append("'\n");
      sb.append(" NumberOfConvertedLeads='").append(com.sforce.ws.util.Verbose.toString(NumberOfConvertedLeads)).append("'\n");
      sb.append(" NumberOfLeads='").append(com.sforce.ws.util.Verbose.toString(NumberOfLeads)).append("'\n");
      sb.append(" NumberOfOpportunities='").append(com.sforce.ws.util.Verbose.toString(NumberOfOpportunities)).append("'\n");
      sb.append(" NumberOfResponses='").append(com.sforce.ws.util.Verbose.toString(NumberOfResponses)).append("'\n");
      sb.append(" NumberOfWonOpportunities='").append(com.sforce.ws.util.Verbose.toString(NumberOfWonOpportunities)).append("'\n");
      sb.append(" NumberSent='").append(com.sforce.ws.util.Verbose.toString(NumberSent)).append("'\n");
