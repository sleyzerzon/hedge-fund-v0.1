...
public class OpportunityCompetitor extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append(super.toString());sb.append(" CompetitorName='").append(com.sforce.ws.util.Verbose.toString(CompetitorName)).append("'\n");
      ...
      sb.append(" Strengths='").append(com.sforce.ws.util.Verbose.toString(Strengths)).append("'\n");
      sb.append(" SystemModstamp='").append(com.sforce.ws.util.Verbose.toString(SystemModstamp)).append("'\n");
      sb.append(" Weaknesses='").append(com.sforce.ws.util.Verbose.toString(Weaknesses)).append("'\n");
      sb.append("]\n");
      return sb.toString();
    }
