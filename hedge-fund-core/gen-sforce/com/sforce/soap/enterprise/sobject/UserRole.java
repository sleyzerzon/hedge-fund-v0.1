...
public class UserRole extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append("[UserRole ");
      sb.append(super.toString());sb.append(" CaseAccessForAccountOwner='").append(com.sforce.ws.util.Verbose.toString(CaseAccessForAccountOwner)).append("'\n");
      sb.append(" ContactAccessForAccountOwner='").append(com.sforce.ws.util.Verbose.toString(ContactAccessForAccountOwner)).append("'\n");
      sb.append(" DeveloperName='").append(com.sforce.ws.util.Verbose.toString(DeveloperName)).append("'\n");
      sb.append(" ForecastUserId='").append(com.sforce.ws.util.Verbose.toString(ForecastUserId)).append("'\n");
      ...
      sb.append(" OpportunityAccessForAccountOwner='").append(com.sforce.ws.util.Verbose.toString(OpportunityAccessForAccountOwner)).append("'\n");
      sb.append(" ParentRoleId='").append(com.sforce.ws.util.Verbose.toString(ParentRoleId)).append("'\n");
      sb.append(" PortalAccountId='").append(com.sforce.ws.util.Verbose.toString(PortalAccountId)).append("'\n");
      sb.append(" PortalAccountOwnerId='").append(com.sforce.ws.util.Verbose.toString(PortalAccountOwnerId)).append("'\n");
      sb.append(" PortalRole='").append(com.sforce.ws.util.Verbose.toString(PortalRole)).append("'\n");
      sb.append(" PortalType='").append(com.sforce.ws.util.Verbose.toString(PortalType)).append("'\n");
      sb.append(" RollupDescription='").append(com.sforce.ws.util.Verbose.toString(RollupDescription)).append("'\n");
