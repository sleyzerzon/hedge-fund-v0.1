 ...
 */
public class WorkCoachingHistory extends com.sforce.soap.enterprise.sobject.SObject {

    /**
     * Constructor
     */
    public WorkCoachingHistory() {}
    ...
    /**
     * element : WorkCoaching of type {urn:sobject.enterprise.soap.sforce.com}WorkCoaching
     * java type: com.sforce.soap.enterprise.sobject.WorkCoaching
     */
    private static final com.sforce.ws.bind.TypeInfo WorkCoaching__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","WorkCoaching","urn:sobject.enterprise.soap.sforce.com","WorkCoaching",0,1,true);

    private boolean WorkCoaching__is_set = false;

    private com.sforce.soap.enterprise.sobject.WorkCoaching WorkCoaching;

    public com.sforce.soap.enterprise.sobject.WorkCoaching getWorkCoaching() {
      return WorkCoaching;
    }

    public void setWorkCoaching(com.sforce.soap.enterprise.sobject.WorkCoaching WorkCoaching) {
      this.WorkCoaching = WorkCoaching;
      WorkCoaching__is_set = true;
    }

    /**
     * element : WorkCoachingId of type {urn:enterprise.soap.sforce.com}ID
     * java type: java.lang.String
     */
    private static final com.sforce.ws.bind.TypeInfo WorkCoachingId__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","WorkCoachingId","urn:enterprise.soap.sforce.com","ID",0,1,true);

    private boolean WorkCoachingId__is_set = false;

    private java.lang.String WorkCoachingId;

    public java.lang.String getWorkCoachingId() {
      return WorkCoachingId;
    }

    public void setWorkCoachingId(java.lang.String WorkCoachingId) {
      this.WorkCoachingId = WorkCoachingId;
      WorkCoachingId__is_set = true;
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "WorkCoachingHistory");
    ...
    protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
       ...
       __typeMapper.writeObject(__out, WorkCoaching__typeInfo, WorkCoaching, WorkCoaching__is_set);
       __typeMapper.writeString(__out, WorkCoachingId__typeInfo, WorkCoachingId, WorkCoachingId__is_set);
    }
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, WorkCoaching__typeInfo)) {
            setWorkCoaching((com.sforce.soap.enterprise.sobject.WorkCoaching)__typeMapper.readObject(__in, WorkCoaching__typeInfo, com.sforce.soap.enterprise.sobject.WorkCoaching.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, WorkCoachingId__typeInfo)) {
            setWorkCoachingId(__typeMapper.readString(__in, WorkCoachingId__typeInfo, java.lang.String.class));
        }
    }
    ...
    public String toString() {
      ...
      sb.append(" WorkCoaching='").append(com.sforce.ws.util.Verbose.toString(WorkCoaching)).append("'\n");
      sb.append(" WorkCoachingId='").append(com.sforce.ws.util.Verbose.toString(WorkCoachingId)).append("'\n");
      sb.append("]\n");
      return sb.toString();
    }
