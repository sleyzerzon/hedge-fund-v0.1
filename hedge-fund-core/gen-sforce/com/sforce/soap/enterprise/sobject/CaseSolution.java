...
public class CaseSolution extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append(" Solution='").append(com.sforce.ws.util.Verbose.toString(Solution)).append("'\n");
      sb.append(" SolutionId='").append(com.sforce.ws.util.Verbose.toString(SolutionId)).append("'\n");
