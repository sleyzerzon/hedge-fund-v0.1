...
public class DashboardComponent extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append(" Dashboard='").append(com.sforce.ws.util.Verbose.toString(Dashboard)).append("'\n");
      sb.append(" DashboardId='").append(com.sforce.ws.util.Verbose.toString(DashboardId)).append("'\n");
