 ...
 */
public class WorkFeedbackQuestionHistory extends com.sforce.soap.enterprise.sobject.SObject {

    /**
     * Constructor
     */
    public WorkFeedbackQuestionHistory() {}
    ...
    /**
     * element : WorkFeedbackQuestion of type {urn:sobject.enterprise.soap.sforce.com}WorkFeedbackQuestion
     * java type: com.sforce.soap.enterprise.sobject.WorkFeedbackQuestion
     */
    private static final com.sforce.ws.bind.TypeInfo WorkFeedbackQuestion__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","WorkFeedbackQuestion","urn:sobject.enterprise.soap.sforce.com","WorkFeedbackQuestion",0,1,true);

    private boolean WorkFeedbackQuestion__is_set = false;

    private com.sforce.soap.enterprise.sobject.WorkFeedbackQuestion WorkFeedbackQuestion;

    public com.sforce.soap.enterprise.sobject.WorkFeedbackQuestion getWorkFeedbackQuestion() {
      return WorkFeedbackQuestion;
    }

    public void setWorkFeedbackQuestion(com.sforce.soap.enterprise.sobject.WorkFeedbackQuestion WorkFeedbackQuestion) {
      this.WorkFeedbackQuestion = WorkFeedbackQuestion;
      WorkFeedbackQuestion__is_set = true;
    }

    /**
     * element : WorkFeedbackQuestionId of type {urn:enterprise.soap.sforce.com}ID
     * java type: java.lang.String
     */
    private static final com.sforce.ws.bind.TypeInfo WorkFeedbackQuestionId__typeInfo =
      new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","WorkFeedbackQuestionId","urn:enterprise.soap.sforce.com","ID",0,1,true);

    private boolean WorkFeedbackQuestionId__is_set = false;

    private java.lang.String WorkFeedbackQuestionId;

    public java.lang.String getWorkFeedbackQuestionId() {
      return WorkFeedbackQuestionId;
    }

    public void setWorkFeedbackQuestionId(java.lang.String WorkFeedbackQuestionId) {
      this.WorkFeedbackQuestionId = WorkFeedbackQuestionId;
      WorkFeedbackQuestionId__is_set = true;
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "WorkFeedbackQuestionHistory");
    ...
    protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
       ...
       __typeMapper.writeObject(__out, WorkFeedbackQuestion__typeInfo, WorkFeedbackQuestion, WorkFeedbackQuestion__is_set);
       __typeMapper.writeString(__out, WorkFeedbackQuestionId__typeInfo, WorkFeedbackQuestionId, WorkFeedbackQuestionId__is_set);
    }
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
        ...
        __in.peekTag();
        if (__typeMapper.isElement(__in, WorkFeedbackQuestion__typeInfo)) {
            setWorkFeedbackQuestion((com.sforce.soap.enterprise.sobject.WorkFeedbackQuestion)__typeMapper.readObject(__in, WorkFeedbackQuestion__typeInfo, com.sforce.soap.enterprise.sobject.WorkFeedbackQuestion.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, WorkFeedbackQuestionId__typeInfo)) {
            setWorkFeedbackQuestionId(__typeMapper.readString(__in, WorkFeedbackQuestionId__typeInfo, java.lang.String.class));
        }
    }
    ...
    public String toString() {
      ...
      sb.append("[WorkFeedbackQuestionHistory ");
      ...
      sb.append(" WorkFeedbackQuestion='").append(com.sforce.ws.util.Verbose.toString(WorkFeedbackQuestion)).append("'\n");
      sb.append(" WorkFeedbackQuestionId='").append(com.sforce.ws.util.Verbose.toString(WorkFeedbackQuestionId)).append("'\n");
      sb.append("]\n");
      return sb.toString();
    }
