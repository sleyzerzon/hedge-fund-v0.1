...
public class UserRecordAccess extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append(super.toString());sb.append(" HasAllAccess='").append(com.sforce.ws.util.Verbose.toString(HasAllAccess)).append("'\n");
      sb.append(" HasDeleteAccess='").append(com.sforce.ws.util.Verbose.toString(HasDeleteAccess)).append("'\n");
      sb.append(" HasEditAccess='").append(com.sforce.ws.util.Verbose.toString(HasEditAccess)).append("'\n");
      sb.append(" HasReadAccess='").append(com.sforce.ws.util.Verbose.toString(HasReadAccess)).append("'\n");
      sb.append(" HasTransferAccess='").append(com.sforce.ws.util.Verbose.toString(HasTransferAccess)).append("'\n");
      sb.append(" MaxAccessLevel='").append(com.sforce.ws.util.Verbose.toString(MaxAccessLevel)).append("'\n");
      sb.append(" RecordId='").append(com.sforce.ws.util.Verbose.toString(RecordId)).append("'\n");
