...
public class AttachedContentDocument extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append(" LinkedEntity='").append(com.sforce.ws.util.Verbose.toString(LinkedEntity)).append("'\n");
      sb.append(" LinkedEntityId='").append(com.sforce.ws.util.Verbose.toString(LinkedEntityId)).append("'\n");
