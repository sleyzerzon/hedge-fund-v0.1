...
public class ApexTrigger extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append(" IsValid='").append(com.sforce.ws.util.Verbose.toString(IsValid)).append("'\n");
      ...
      sb.append(" LengthWithoutComments='").append(com.sforce.ws.util.Verbose.toString(LengthWithoutComments)).append("'\n");
      ...
      sb.append(" UsageAfterDelete='").append(com.sforce.ws.util.Verbose.toString(UsageAfterDelete)).append("'\n");
      sb.append(" UsageAfterInsert='").append(com.sforce.ws.util.Verbose.toString(UsageAfterInsert)).append("'\n");
      sb.append(" UsageAfterUndelete='").append(com.sforce.ws.util.Verbose.toString(UsageAfterUndelete)).append("'\n");
      sb.append(" UsageAfterUpdate='").append(com.sforce.ws.util.Verbose.toString(UsageAfterUpdate)).append("'\n");
      sb.append(" UsageBeforeDelete='").append(com.sforce.ws.util.Verbose.toString(UsageBeforeDelete)).append("'\n");
      sb.append(" UsageBeforeInsert='").append(com.sforce.ws.util.Verbose.toString(UsageBeforeInsert)).append("'\n");
      sb.append(" UsageBeforeUpdate='").append(com.sforce.ws.util.Verbose.toString(UsageBeforeUpdate)).append("'\n");
      sb.append(" UsageIsBulk='").append(com.sforce.ws.util.Verbose.toString(UsageIsBulk)).append("'\n");
      sb.append("]\n");
      return sb.toString();
    }
