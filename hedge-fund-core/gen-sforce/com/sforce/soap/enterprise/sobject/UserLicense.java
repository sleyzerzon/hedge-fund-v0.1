...
public class UserLicense extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append(super.toString());sb.append(" LicenseDefinitionKey='").append(com.sforce.ws.util.Verbose.toString(LicenseDefinitionKey)).append("'\n");
      sb.append(" MonthlyLoginsEntitlement='").append(com.sforce.ws.util.Verbose.toString(MonthlyLoginsEntitlement)).append("'\n");
      sb.append(" MonthlyLoginsUsed='").append(com.sforce.ws.util.Verbose.toString(MonthlyLoginsUsed)).append("'\n");
      sb.append(" Name='").append(com.sforce.ws.util.Verbose.toString(Name)).append("'\n");
      sb.append(" SystemModstamp='").append(com.sforce.ws.util.Verbose.toString(SystemModstamp)).append("'\n");
      sb.append(" userlicenses='").append(com.sforce.ws.util.Verbose.toString(userlicenses)).append("'\n");
      sb.append("]\n");
      return sb.toString();
    }
