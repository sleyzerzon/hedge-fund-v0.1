...
public class FiscalYearSettings extends com.sforce.soap.enterprise.sobject.SObject {
    ...
    public String toString() {
      ...
      sb.append(" IsStandardYear='").append(com.sforce.ws.util.Verbose.toString(IsStandardYear)).append("'\n");
      sb.append(" Name='").append(com.sforce.ws.util.Verbose.toString(Name)).append("'\n");
      sb.append(" PeriodId='").append(com.sforce.ws.util.Verbose.toString(PeriodId)).append("'\n");
      sb.append(" PeriodLabelScheme='").append(com.sforce.ws.util.Verbose.toString(PeriodLabelScheme)).append("'\n");
      sb.append(" PeriodPrefix='").append(com.sforce.ws.util.Verbose.toString(PeriodPrefix)).append("'\n");
      sb.append(" Periods='").append(com.sforce.ws.util.Verbose.toString(Periods)).append("'\n");
      sb.append(" QuarterLabelScheme='").append(com.sforce.ws.util.Verbose.toString(QuarterLabelScheme)).append("'\n");
      sb.append(" QuarterPrefix='").append(com.sforce.ws.util.Verbose.toString(QuarterPrefix)).append("'\n");
      ...
      sb.append(" WeekLabelScheme='").append(com.sforce.ws.util.Verbose.toString(WeekLabelScheme)).append("'\n");
      sb.append(" WeekStartDay='").append(com.sforce.ws.util.Verbose.toString(WeekStartDay)).append("'\n");
      sb.append(" YearType='").append(com.sforce.ws.util.Verbose.toString(YearType)).append("'\n");
      sb.append("]\n");
      return sb.toString();
    }
