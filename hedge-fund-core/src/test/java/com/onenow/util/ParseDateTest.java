...
public class ParseDateTest {
  ...
  public void getDashedDatePlus() {
		...
		String actualDateOut1 = ParseTime.getDashedDatePlus(date1, delta);	
		String actualDateOut2 = ParseTime.getDashedDatePlus(date2, delta);	
		String actualDateOut3 = ParseTime.getDashedDatePlus(date3, delta);	
